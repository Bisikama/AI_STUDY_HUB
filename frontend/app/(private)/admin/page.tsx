...
export default function AdminOverviewPage() {
  ...
  const pendingDocs = metrics ? metrics.totalDocuments : 0;
        ...
        <div className="flex items-center justify-between">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Manage institutional access, roles, and account statuses from a centralized hub.
            </p>
          </div>
          ...
          <div className="border-b border-slate-100 px-6 py-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                {usersLoading ? 'Loading...' : `${filtered.length} ${filtered.length === 1 ? 'entry' : 'entries'} found`}
              </p>
            </div>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-100 bg-slate-50/60">
                  <th className="px-6 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-slate-400">User ID</th>
                  <th className="px-6 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-slate-400">Full Name</th>
                  <th className="px-6 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-blue-400">Email Address</th>
                  <th className="px-6 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-slate-400">Registration</th>
                  <th className="px-6 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-slate-400">Docs</th>
                  <th className="px-6 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-blue-400">Current Role</th>
