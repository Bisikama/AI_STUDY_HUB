  ...
  return (
    <div className="pointer-events-none fixed right-6 bottom-6 z-50 flex flex-col gap-3">
      {toasts.map((t) => (
        <div
          key={t.id}
          className={`pointer-events-auto flex max-w-sm min-w-[300px] items-center gap-3 rounded-xl px-4 py-3.5 text-sm font-medium text-white shadow-xl ring-1 transition-all duration-300 animate-in slide-in-from-bottom-5 fade-in ${t.variant === 'success'
            ? 'bg-emerald-600 ring-emerald-700/50 shadow-emerald-900/20'
            : 'bg-red-600 ring-red-700/50 shadow-red-900/20'
            }`}
        >
          {t.variant === 'success' ? (
  ...
  return (
    <aside className="flex h-screen w-64 shrink-0 flex-col border-r border-slate-200 bg-white">
      ...
      <div className="flex items-center gap-3 px-6 py-6">
        ...
        <div>
          <p className="text-sm leading-none font-bold tracking-tight text-slate-900">AI STUDY HUB</p>
      ...
      <nav className="flex-1 space-y-1 px-4 py-4">
        {navItems.map((item) => (
          <a
            key={item.label}
            href={item.href}
            className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-all duration-200 ${item.active
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-10 md:px-8">
        ...
        <div
          {...getRootProps()}
          className={`mb-6 cursor-default rounded-2xl border-2 border-dashed px-10 py-16 text-center transition-all duration-200 ${isDragActive
        ...
        >
          ...
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-slate-100 shadow-sm ring-4 ring-slate-50">
            <svg className="h-7 w-7 text-slate-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-sm text-slate-900 placeholder-slate-400 outline-none transition-all focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
              />
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <select
                  ...
                  disabled={isMutating}
                  className="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-sm text-slate-900 outline-none transition-all focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
                >
            ...
            <div>
              ...
              <div className="flex gap-3">
                <select
                  ...
                  disabled={isMutating}
                  className="flex-1 rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-sm text-slate-900 outline-none transition-all focus:border-slate-400 focus:bg-white focus:ring-4 focus:ring-slate-100 disabled:cursor-not-allowed disabled:opacity-60"
                >
              ...
              {showCreateFolder && (
                <div className="mt-3 flex gap-3 animate-in fade-in slide-in-from-top-2">
                  <input
                    ...
                    className="flex-1 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none transition-all focus:border-slate-400 focus:ring-4 focus:ring-slate-100"
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
                        e.preventDefault();
                        handleCreateFolder();
              ...
              <div className="flex min-h-[52px] flex-wrap items-center gap-2 rounded-xl border border-slate-200 bg-slate-50/50 px-3 py-2 transition-all focus-within:border-slate-400 focus-within:bg-white focus-within:ring-4 focus-within:ring-slate-100">
                ...
                <div className="relative flex-1 min-w-[150px]">
                  ...
                  {showTagDropdown && availableTags.length > 0 && (
                    <div className="absolute left-0 top-full z-10 mt-2 max-h-56 w-full overflow-y-auto rounded-xl border border-slate-200 bg-white p-1 shadow-lg ring-1 ring-slate-900/5">
                      {availableTags
